...
# 僅用本地 JSON、不呼叫 CMC
python -m fng_trading.backtest.fng_backtest_with_binance_tp --skip-fetch
...
```bash
cd /path/to/dashboard   # 父目錄，使 fng_trading 可被 -m 匯入
pip install -r fng_trading/requirements.txt
```
